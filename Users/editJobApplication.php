<?php
include_once("../php/editJobApplication_action.php");
...
<body>
    ...
    <div class="conatiner d-flex justify-content-center">
        <form action="../php/editJobApplication_action.php" class="w-50 border border-5 rounded-4 bg-dark-subtle p-3 my-5" method="POST">
            ...
            <div class="mb-3 ">Height: <span class="text-danger">*<?php echo $_SESSION['error']['height'] ?></span> 
                <input type="number" name='height' class="form-control" value="<?php echo $application_row['height'];  ?>"></div>
            <div class="mb-3 ">High School Percentage: <span class="text-danger">*<?php echo $_SESSION['error']['highschool'] ?></span> 
                <input type="number" name='highschool_percentage' class="form-control" value="<?php echo $application_row['highschool_percentage'];  ?>"></div>
            <div class="mb-3 ">Intermediate Percentage: <span class="text-danger">*<?php echo $_SESSION['error']['intermediate'] ?></span> 
                <input type="number" name='intermediate_percentage' class="form-control" value="<?php echo $application_row['intermediate_percentage'];  ?>"></div>
            <div class="mb-3 ">Prefered Job Location: <span class="text-danger">* <?php echo $_SESSION['error']['job_location'] ?> </span> 
                <select name="prefered_job_location" class="form-control">
                    ...
                    <?php
                        ...
                        // print_r($arr);
                        foreach ($arr as $a){ ?>
                    <option value="<?php echo $a ?>" <?php if($a == $application_row['prefered_job_location']){echo "selected";} ?>><?php echo $a; ?></option>
                    <?php } ?>
                </select>
            </div>
            <div class="mb-3 ">Prefered exam center: <span class="text-danger">* <?php echo $_SESSION['error']['exam_center'] ?> </span> 
                <select name="prefered_exam_center" class="form-control">
                    ...
                    <?php
                        ...
                        // print_r($arr);
                        foreach ($arr as $a){ ?>
                    <option value="<?php echo $a ?>"<?php if($a == $application_row['prefered_exam_center']){echo "selected";} ?>><?php echo $a; ?></option>
                    <?php } ?>
                </select>
            </div>

            <div class="mb-3 ">Address: <span class="text-danger">* <?php echo $_SESSION['error']['address'] ?> </span>
                <input type="text" name='address' class="form-control" value="<?php echo $application_row['address'];  ?>"></div>
